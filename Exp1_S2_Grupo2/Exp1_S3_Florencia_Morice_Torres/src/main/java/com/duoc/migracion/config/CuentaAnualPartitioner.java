...
public class CuentaAnualPartitioner implements Partitioner {

    private static final Logger logger = LoggerFactory.getLogger(CuentaAnualPartitioner.class);
    private final String resourcePath = "data/cuentas_anuales.csv";
    ...
    public Map<String, ExecutionContext> partition(int gridSize) {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
            ...
            logger.info("Total cuentaAnual records (excluding header): {}", total);
            ...
            for (int i = 0; i < gridSize; i++) {
                ...
                File tmp = File.createTempFile("cuentaAnual-part-" + i + "-", ".csv");
                tmp.deleteOnExit();
