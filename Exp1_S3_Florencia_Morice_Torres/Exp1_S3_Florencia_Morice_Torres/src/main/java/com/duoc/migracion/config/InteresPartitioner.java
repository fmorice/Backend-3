...
public class InteresPartitioner implements Partitioner {

    private static final Logger logger = LoggerFactory.getLogger(InteresPartitioner.class);
    private final String resourcePath = "data/intereses.csv";
    ...
    public Map<String, ExecutionContext> partition(int gridSize) {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
            ...
            logger.info("Total interes records (excluding header): {}", total);
            ...
            for (int i = 0; i < gridSize; i++) {
                ...
                File tmp = File.createTempFile("interes-part-" + i + "-", ".csv");
                tmp.deleteOnExit();
